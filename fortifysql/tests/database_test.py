...
def test_basic_queries():
    ...
    database.query(
        "CREATE TABLE IF NOT EXISTS people (Id INTEGER PRIMARY KEY, Age INTEGER, Name TEXT)"
    )
...
def test_drop_configuration():
    ...
    initial_table_exists = database.query(
        "SELECT name FROM sqlite_master WHERE type='table' AND name='toDrop'; ",
        save_data=True,
    )
    try:
