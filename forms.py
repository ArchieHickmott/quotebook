...
class LoginForm(FlaskForm):
    email = StringField(
        "Email",
        [InputRequired("Please enter your email"), Email("Please enter your email")],
...
class RegisterForm(FlaskForm):
    first_name = StringField(
        "First Name | Required",
        [InputRequired("please enter a first name")],
        render_kw={"placeholder": "First Name", "required": True},
    )
    last_name = StringField("Last Name", render_kw={"placeholder": "Last Name"})
    email = StringField(
        "Email | Required",
        [InputRequired("please enter an email"), Email("not a valid email")],
        render_kw={"placeholder": "Email", "required": True},
    )
    password = PasswordField(
        "Password | Required",
        [InputRequired("please enter a password")],
        render_kw={"placeholder": "Password", "required": True},
    )
    confirm_password = PasswordField(
        "Confirm Password | Required",
        [InputRequired("please confirm your password")],
        render_kw={"placeholder": "Confirm Password", "required": True},
    )
...
class UpdateDataForm(FlaskForm):
    first_name = StringField(
        "First Name", render_kw={"placeholder": "First Name", "required": True}
    )
    last_name = StringField("Last Name", render_kw={"placeholder": "Last Name"})
    password = PasswordField(
        "Password",
